...
Score: **0.18**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  **Number of projects on GitHub that use an open source project:** 117
1.  **Number of stars for a GitHub repository:** 103
