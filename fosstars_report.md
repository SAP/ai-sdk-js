...
1.  **[Security testing](#security-testing)**: **6.94** (weight is 1.0)
...
Score: **6.94**, confidence is 10.0 (max), weight is 1.0 (high)
...
239 commits in the last 3 months results to 10.00 points
...
1.  **Number of commits in the last three months:** 239
...
1.  **Number of projects on GitHub that use an open source project:** 147
