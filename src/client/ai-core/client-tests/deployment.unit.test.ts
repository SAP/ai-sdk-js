...
describe('deployment unit tests', () => {
    ...
    it('get deployment parses a successful response', async () => {
        ...
        const result: DeploymentList =
            await DeploymentApi.deploymentQuery({}, {'AI-Resource-Group': 'default'})
            .execute(destination);
        ...
        expect(deployment.configurationId).toBe('7652a231-ba9b-4fcc-b473-2c355cb21b61');
    ...
    it('post deployment parses a successful response', async () => {
        ...
        const result: DeploymentCreationResponse =
            await DeploymentApi.deploymentCreate(deploymentPostData, {'AI-Resource-Group': 'default'})
            .execute(destination);
    ...
    it('patch deployment parses a successful response', async () => {
        ...
        const result: DeploymentModificationResponse = 
            await DeploymentApi.deploymentModify(deploymentId, deploymentPatchData, {'AI-Resource-Group': 'default'})
            .execute(destination);
    ...
    it('delete deployment parses a successful response', async () => {
        ...
        const result: DeploymentDeletionResponse = 
            await DeploymentApi.deploymentDelete(deploymentId, {'AI-Resource-Group': 'default'})
            .execute(destination);
