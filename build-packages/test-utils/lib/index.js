 ...
 * @internal
 */
export function mockFsWithMemfs(j) {
    j.unstable_mockModule('fs', () => import('memfs').then(m => ({
        ...m.fs,
        default: m.fs,
        __esModule: true
    })));
    j.unstable_mockModule('fs/promises', () => import('memfs').then(m => ({
        ...m.fs.promises,
        default: m.fs.promises,
        __esModule: true
    })));
    j.unstable_mockModule('node:fs', () => import('memfs').then(m => ({
        ...m.fs,
        default: m.fs,
        __esModule: true
    })));
    j.unstable_mockModule('node:fs/promises', () => import('memfs').then(m => ({
        ...m.fs.promises,
        default: m.fs.promises,
        __esModule: true
    })));
 ...
 * @internal
 */
export function defineActionConfig(actionName) {
