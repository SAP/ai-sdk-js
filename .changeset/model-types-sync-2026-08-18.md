...
[Improvement] Added `mistralai--mistral-medium`, `sap-rpt-1.5`, `sap-rpt-1.5-large`, `sap-rpt-1.6`, `sap-rpt-1.6-large`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` to the available model list.
