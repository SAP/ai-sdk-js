...
This style guide defines coding standards for the SAP Cloud SDK for AI.
...
Those that could be enforced by lint but currently aren't are marked: (enforceable).

#### Table of Contents

- [Naming](#naming)
  - [Use kebab case for file names (enforceable)](#use-kebab-case-for-file-names-enforceable)
  - [Use camel case for variable names (enforceable)](#use-camel-case-for-variable-names-enforceable)
  - [Use pascal case for classes (enforceable)](#use-pascal-case-for-classes-enforceable)
  - [Use pascal case for interface names and don't prefix them (enforceable)](#use-pascal-case-for-interface-names-and-dont-prefix-them-enforceable)
  - [Use pascal case for enums and enum properties (enforceable)](#use-pascal-case-for-enums-and-enum-properties-enforceable)
  - [Use camel case for acronyms](#use-camel-case-for-acronyms)
  - [Use verbs in function names](#use-verbs-in-function-names)
- [Strings](#strings)
  - [Use single quotes ✓](#use-single-quotes-)
- [Arrays](#arrays)
  - [Use `.forEach` and other array functions rather than `for` (enforceable)](#use-foreach-and-other-array-functions-rather-than-for-enforceable)
...
- [White space](#white-space)
  ...
  - [Add one empty line before and after function definitions (enforceable)](#add-one-empty-line-before-and-after-function-definitions-enforceable)
- [Comments](#comments)
...
- [Promises](#promises)
  - [Use `async`/`await` rather than `.then` (enforceable)](#use-asyncawait-rather-than-then-enforceable)
  - [Use `try ... catch` and `.catch` with `async`/`await`](#use-try--catch-and-catch-with-asyncawait)
- [Functions](#functions)
  - [Use arrow functions for callbacks (enforceable)](#use-arrow-functions-for-callbacks-enforceable)
...
### Use kebab case for file names (enforceable)
...
### Use camel case for variable names (enforceable)
...
/* Use camel case for static variables */
class FooBar {
  static fooBar;
}
```

### Use pascal case for classes (enforceable)
...
### Use pascal case for interface names and don't prefix them (enforceable)
...
### Use pascal case for enums and enum properties (enforceable)
...
Feel free to concatenate strings with `+` in case it makes the code better readable.
...
### Use `.forEach` and other array functions rather than `for` (enforceable)
...
### Add one empty line before and after function definitions (enforceable)
...
### Use `async`/`await` rather than `.then` (enforceable)
...
### Use arrow functions for callbacks (enforceable)
