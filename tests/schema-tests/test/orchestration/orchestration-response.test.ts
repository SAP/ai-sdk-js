...
describe('Orchestration chat completion response', () => {
  it('should parse the chat completion success response', () => {
  ...
  it('should parse the chat completion message history response', () => {
    const mockResponse = parseMockResponse<any>(
      'orchestration',
  ...
  it('should parse the chat completion filter config response', () => {
    const mockResponse = parseMockResponse<any>(
      'orchestration',
