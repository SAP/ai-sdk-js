...
import type { AiArtifactName } from './ai-artifact-name';
import type { AiArtifactUrl } from './ai-artifact-url';
import type { AiArtifactDescription } from './ai-artifact-description';
import type { AiArtifactId } from './ai-artifact-id';
