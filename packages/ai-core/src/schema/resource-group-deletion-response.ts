...
import type { ResourceGroupDeletionResponseMessage } from './resource-group-deletion-response-message.js';
/**
 * Representation of the 'ResourceGroupDeletionResponse' schema.
 */
export type ResourceGroupDeletionResponse = CreationResponse2 & {
