 ...
 */
import type { ArgoCDApplicationStatusSource } from './argo-cd-application-status-source.js';
import type { ArgoCDApplicationStatusSyncResourcesStatus } from './argo-cd-application-status-sync-resources-status.js';
/**
