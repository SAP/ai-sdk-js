...
import type { ConfigurationCreationResponseMessage } from './configuration-creation-response-message.js';
/**
 * Representation of the 'ConfigurationCreationResponse' schema.
 */
export type ConfigurationCreationResponse = CreationResponse & {
