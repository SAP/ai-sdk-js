...
import type { ExecutionModificationResponseMessage } from './execution-modification-response-message.js';
/**
 * Representation of the 'ExecutionModificationResponse' schema.
 */
export type ExecutionModificationResponse = CreationResponse & {
