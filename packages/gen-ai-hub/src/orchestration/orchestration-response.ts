...
*/
  getContent(choiceIndex: number = 0): string | undefined {
    ...
    if (choices[choiceIndex].message.content === '' && choices[choiceIndex].finish_reason === 'content_filter') {
      throw new Error('Content generated by LLM was filtered by the Output Filter. Please try again with a different prompt or filter configuration.');
    }
