...
export class OrchestrationStreamResponse<T> {
  ...
  /**
   * Parses the orchestration response and returns the reasoning content (thinking blocks) generated by the model.
   * @param choiceIndex - The index of the choice to parse.
   * @returns The thinking blocks, or undefined if not present.
   */
