...
export class OrchestrationStreamResponse<T> {
  ...
  /**
   * Parses the orchestration stream response and returns the accumulated reasoning content generated by the model.
   ...
   * When reasoning content is present, it is automatically included in the returned messages.
   * Pass the result directly as messagesHistory in the next request to maintain reasoning context.
   * Only available after the stream has been fully consumed.
   * @param choiceIndex - The index of the choice to parse.
   * @returns A list of all messages including any reasoning content, or undefined if the stream is still open.
   */
