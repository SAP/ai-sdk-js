...
import type { AgentControllerServicecdsMapUpdate } from './agent-controller-servicecds-map-update.js';
/**
 * Representation of the 'AgentControllerServiceAgentsUpdate' schema.
 */
export type AgentControllerServiceAgentsUpdate = {
  /**
   ...
   */
  orchestrationConfig?: AgentControllerServicecdsMapUpdate | null;
  /**
