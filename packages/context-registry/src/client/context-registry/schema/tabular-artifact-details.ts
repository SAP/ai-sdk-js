...
import type { TabularArtifactErrorMessage } from './tabular-artifact-error-message.js';
import type { TabularArtifactStatus } from './tabular-artifact-status.js';
/**
 * Representation of the 'TabularArtifactDetails' schema.
 */
export type TabularArtifactDetails = {
  /**
  ...
  status: TabularArtifactStatus;
  errorMessage?: TabularArtifactErrorMessage;
  csnMetadata?:
    | ({
        /**
