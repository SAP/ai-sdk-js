/* eslint-disable */
// disable eslint for this vendored file
/**
 * @packageDocumentation
 * This file is a vendored version of the compress-request-middleware from https://github.com/SAP/cloud-sdk-js/pull/6291.
 * It is included here to allow testing and usage of request compression middleware in the RPT client.
 * Unit tests are not included here, but can be found in the original PR.
 */
