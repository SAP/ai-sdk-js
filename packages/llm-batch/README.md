...
This package provides a client for the SAP AI Core LLM Batch API, enabling asynchronous batch processing of large language model requests.
...
```
$ npm install @sap-ai-sdk/llm-batch
```
