 ...
 * @typeParam ModelNameT - String literal type representing the name of the model.
 */
export type ModelDeployment<ModelNameT = string> = ModelNameT | ((ModelConfiguration<ModelNameT> | DeploymentIdConfiguration) & ResourceGroupConfiguration);
/**
 ...
 * @internal
 */
export declare function getDeploymentId(modelDeployment: ModelDeployment, executableId: string): Promise<string>;
