 ...
 */
function isDeploymentIdConfiguration(modelDeployment) {
...
async function getAllDeployments(opts) {
    ...
    try {
        ...
        }, { 'AI-Resource-Group': resourceGroup }).execute();
 ...
 * @internal
 */
export async function getDeploymentId(modelDeployment, executableId) {
