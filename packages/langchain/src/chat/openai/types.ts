...
import { OpenAiChatCompletionParameters, OpenAiChatModel } from '@sap-ai-sdk/gen-ai-hub';

/**
 * Input for Text generation for OpenAI GPT.
 */
export interface OpenAIChatModelInterface
  extends Omit<OpenAIChatInput, 'openAIApiKey' | 'streaming' | 'model' | 'modelName' >,
...
export interface OpenAIChatCallOptions
  extends Omit<ChatOpenAICallOptions, 'tool_choice' | 'promptIndex' | 'functions' | 'function_call' | 'tools' | 'response_format'>,
  Pick<OpenAiChatCompletionParameters, 'tool_choice' | 'functions' | 'tools' | 'response_format'> {}
